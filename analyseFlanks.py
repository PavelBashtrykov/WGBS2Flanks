...
from utils.readers import ComputeFlanksCSVReader, read_input
...
def main():
    ...
    parser.add_argument("-i", "--infile", nargs="+", help="Input file(s) containing flanks data, generated by \"computeFlanks.py\"", required=True)
    parser.add_argument("-c", "--comparison", type=str, help="File containing flanks preferences for comparison (DNMTs, TETs, etc.)", required=True  )
